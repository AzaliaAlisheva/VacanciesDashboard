...
with open("hh_jobs.csv", "r", encoding='utf-8') as input:
    with open("../backend/skills.json", "r", encoding='utf-8') as skills_file:
    ...
    with open("../backend/extended_data.csv", "w", encoding='utf-8') as output:
